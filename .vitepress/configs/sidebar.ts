  ...
  "/windows/": [
    {
      ...
      items: [
        ...
        { text: "恢复经典资源管理器和右键菜单", link: "/windows/classic-explorer" },
        { text: "文件与 Base64 相互转换", link: "/windows/base64-file-convert" },
        { text: "CMD 获取返回值第一个结果", link: "/windows/cmd-for-first"},
        { text: "命令行颜色代码", link: "/windows/cmd-colors"},
        { text: "PowerShell 创建快捷方式", link: "/windows/powershell-shortcut"},
        { text: "在 PowerShell 中创建符号链接", link: "/windows/powershell-link"},
      ],
    },
  ],
  "/docker/": [
  ...
  "/software/": [
    {
      ...
      items: [
        ...
        { text: "将编号转换为文本", link: "/software/numstotext" },
      ],
    },
  ],
};
